...
const SideMenu = ({ workflows, selectedWorkflows, onWorkflowToggle, colorsMap }) => {
    return (
        <div className="overflow-y-auto w-64 min-w-32 bg-gray-50 border-r border-gray-200 px-4">
            <h3 className="text-xl font-semibold my-4 ml-1 text-black">Workflows</h3>
